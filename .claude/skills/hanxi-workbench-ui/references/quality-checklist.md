# Hanxi Workbench UI Quality Checklist

Run this checklist before declaring substantial Hanxi UI work complete. Check only states and patterns that apply to the task.
