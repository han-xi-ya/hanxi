...
.msix-eyebrow { color: var(--color-primary); font: 700 var(--text-micro)/1.2 var(--font-mono); letter-spacing: 0.1em; }
.msix-overview h2 { margin: 8px 0 6px; font-size: var(--text-xl); }
.msix-overview p { margin: 0; color: var(--color-text-muted); font-size: var(--text-base); line-height: 1.65; }
...
.msix-facts dt { color: var(--color-text-muted); font-size: var(--text-xs); }
.msix-facts dd { margin: 0; overflow-wrap: anywhere; font: var(--text-sm)/1.45 var(--font-mono); }
