...
async function loadVersions() {
  await loadManagedVersions({
    remote: LiteMonitorAPI.ListReleases,
    local: LiteMonitorAPI.ListInstalledVersions,
    active: LiteMonitorAPI.GetActiveVersion,
...
/* ---------- 提示与说明卡（.banner.slim 改由全局原子接管，模板挂 class="slim"；
   hint-line 原 line-height:1.6 散差按标准形（无行距档）定档删除） ---------- */
...
.lm-ver-status { display: inline-flex; align-items: center; gap: 6px; font-size: var(--text-sm); white-space: nowrap; }
