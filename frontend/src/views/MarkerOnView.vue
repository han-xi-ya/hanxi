...
/* ---------- 顶部整合控制条（control-bar 四件套/uptime-tag 由全局原子接管） ---------- */
...
/* status-word/ver-pill/pid-tag、info-* 折叠卡家族由 components.css 全局原子接管 */
...
/* control-panel/meta-info/btn-group、section-title h3/empty-hint 由 components.css 全局原子接管 */
/* .empty-state 空态全局原子接管（components.css） */

/* ---------- 已安装卡片（installed-grid/installed-card/inst-card-top/inst-badges/ver-tag 由全局原子接管） ---------- */
