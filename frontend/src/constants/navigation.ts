...
export const ROUTES: Record<string, RouteDef> = {
  ...
  '/ext/webapp': { component: defineAsyncComponent(() => import('@/views/WebAppView.vue')), moduleId: 'webapp' },
...
export const MODULE_PRESENTATION: Record<string, { icon: string; route: string }> = {
  ...
  markeron: { icon: 'app:markeron', route: '/ext/markeron' },
  everything: { icon: 'app:everything', route: '/ext/everything' },
