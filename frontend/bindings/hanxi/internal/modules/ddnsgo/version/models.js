 ...
 * @typedef {Object} DdnsRelease
 * @property {string} version - 如 v6.17.6
 * @property {string} published - 发布时间（RFC3339）
 * @property {boolean} isPre - 是否为预发布版本
 * @property {string} assetName - 如 ddns-go_6.17.6_windows_x86_64.zip
 ...
 * @typedef {Object} DdnsVersionInfo
 * @property {string} version - 如 v6.17.6
 * @property {string} exePath - ddns-go.exe 完整路径（供托管启动使用）
 * @property {string} dir - 版本隔离目录
 * @property {number} size - ddns-go.exe 大小（字节）
