 ...
 * @typedef {Object} CCRelease
 * @property {string} version - 如 v3.20.0
 * @property {string} published - 发布时间（RFC3339）
 * @property {boolean} isPre - 是否为预发布版本
 * @property {string} assetName - 如 CC-Switch-v3.20.0-Windows-Portable.zip
 ...
 * @typedef {Object} CCVersionInfo
 * @property {string} version - 如 v3.20.0
 * @property {string} exePath - cc-switch.exe 完整路径（供启动/唤窗使用）
 * @property {string} dir - 版本隔离目录（exe 与 portable.ini 同目录）
 * @property {number} size - cc-switch.exe 大小（字节）
