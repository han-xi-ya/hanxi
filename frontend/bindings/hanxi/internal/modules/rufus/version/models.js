 ...
 * @typedef {Object} RufusRelease
 * @property {string} version - 如 v4.15（tag 原样带 v 前缀）
 * @property {string} published - 发布时间（RFC3339）
 * @property {boolean} isPre - 是否为预发布版本
 * @property {string} assetName - 如 rufus-4.15p.exe
 ...
 * @typedef {Object} RufusVersionInfo
 * @property {string} version - 如 v4.15
 * @property {string} exePath - rufus.exe 完整路径（供启动/唤窗使用）
 * @property {string} dir - 版本隔离目录（exe 与 rufus.ini 同目录）
 * @property {number} size - rufus.exe 大小（字节）
