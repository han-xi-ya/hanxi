...
export function DownloadVersion(targetVersion) {
    return $Call.ByID(3913320741, targetVersion);
}
 ...
 * @returns {$CancellablePromise<version$0.RDVersionInfo>}
 */
export function ImportLocal(srcPath) {
    return $Call.ByID(3548955573, srcPath);
}
...
export function InstallVersion(targetVersion) {
    return $Call.ByID(4076029290, targetVersion);
}
 ...
 * @returns {$CancellablePromise<version$0.RDVersionInfo[] | null>}
 */
export function ListInstalledVersions() {
    return $Call.ByID(3569750006);
}

/**
 * ListReleases 获取远程可用版本列表（多镜像回退，10 分钟缓存）。
 * @returns {$CancellablePromise<version$0.RDRelease[] | null>}
 */
export function ListReleases() {
    return $Call.ByID(2730113725);
}
...
export function OpenDir(dir) {
    return $Call.ByID(906222690, dir);
}
...
export function RemoveVersion(targetVersion) {
    return $Call.ByID(2243231133, targetVersion);
}
...
export function SetActiveVersion(targetVersion, form) {
    return $Call.ByID(1014719601, targetVersion, form);
}
