 ...
 * @typedef {Object} QuickLookRelease
 * @property {string} version - 如 4.5.0（上游 tag 无 v 前缀）
 * @property {string} published - 发布时间（RFC3339）
 * @property {boolean} isPre - 是否为预发布版本
 * @property {string} assetName - 如 QuickLook-4.5.0.zip
 ...
 * @typedef {Object} QuickLookVersionInfo
 * @property {string} version - 如 4.5.0
 * @property {string} exePath - QuickLook.exe 完整路径（供托管启停使用）
 * @property {string} dir - 版本隔离目录（exe 与 portable.lock、插件同处）
 * @property {number} size - QuickLook.exe 大小（字节）
