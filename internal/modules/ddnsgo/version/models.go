...
type DdnsRelease struct {
	Version   string `json:"version"`   // 如 v6.17.6
	Published string `json:"published"` // 发布时间（RFC3339）
	IsPre     bool   `json:"isPre"`     // 是否为预发布版本
	AssetName string `json:"assetName"` // 如 ddns-go_6.17.6_windows_x86_64.zip
...
type DdnsVersionInfo struct {
	Version     string `json:"version"`     // 如 v6.17.6
	ExePath     string `json:"exePath"`     // ddns-go.exe 完整路径（供托管启动使用）
	Dir         string `json:"dir"`         // 版本隔离目录
	Size        int64  `json:"size"`        // ddns-go.exe 大小（字节）
