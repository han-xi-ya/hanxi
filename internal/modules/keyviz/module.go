...
func New(plat platform.Platform) extapi.Module {
	return &Module{svc: NewKeyvizService(plat, extapi.NewLeaseHolder(ID))}
}
...
func (e *Module) Nav() []extapi.NavEntry {
	return []extapi.NavEntry{
		{ID: "keyviz-manager", Title: "Keyviz 键显", Route: "/ext/keyviz", Icon: "app:keyviz", Section: extapi.SectionExt, Order: 82, Group: extapi.GroupDesktop},
	}
}
